<template>
  ...
  <div class="NavBar-Wrapper LayoutCenter-Frame"
    :class="{ 'aside-fixed': $router.meta?.asideFixed, 'height-fixed': !$route.meta?.heightUnlimited, 'width-larger': $route.meta?.largerWidth }">
